...
$(document).ready(function()
{
	...
	{
		$(location).attr("href", "join.action?id=" + $("#id").val() + "&pw=" + $("#pw").val());
	})
})
...
<!--         create account form -->
        <form action="join.action" class="login__create none" id="login-up">
          ...
          <div class="login__box">
            <i class='bx bx-user login__icon'></i>
            <input type="text" id="id" placeholder="Username" class="login__input">
          </div>
          
          <div class="login__box">
            <i class='bx bx-lock login__icon'></i>
            <input type="text" id="pw" placeholder="Password" class="login__input">
          </div>        
