...
<head>
<meta charset="UTF-8">
<title>Admin_report_process.jsp</title>
<!-- BootStrap -->
					...
					<table class="table no-wrap">
						<thead>
							<tr class="text-center">
								...
								<th class="border-top-0">처리 사유</th>
								<th class="border-top-0">신고 내용</th>
								<th class="border-top-0">처리 날짜</th>
								<th class="border-top-0">결과</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td class="text-center">기술 Q&A 게시판 댓글</td>
								<td class="text-center">욕설</td>
								<td class="text-center ellipsis-content" data-toggle="tooltip" data-placement="top" title="전체 내용을 보려면 클릭하세요.">저는 단순히 코딩하다모르는 문제가 나와 게시판에 질문을 올렸는데 갑자기 부모님 안부를 물어봐서 기분이 너무 나빠서 신고했습니다;;;</td>
								<td class="text-center">처리완료</td>
								<td class="text-center">2024-02-28</td>
								<td class="text-center">10일 작성 금지</td>
							<tr>	
						</tbody>
					</table>
				</div>
