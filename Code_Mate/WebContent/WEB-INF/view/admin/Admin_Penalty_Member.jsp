...
<head>
<meta charset="UTF-8">
<title>Admin_Penalty_Member.jsp</title>
<!-- BootStrap -->
					...
					<table class="table no-wrap">
						<thead>
							<tr class="text-center">
								...
								<th class="border-top-0">신고유형</th>
								<th class="border-top-0">사유</th>
								<th class="border-top-0">신고일자</th>
								<th class="border-top-0">처리내용</th>
								<th class="border-top-0">처리일자</th>
								<th class="border-top-0">처리유형</th>
							</tr>
						</thead>
						<tbody>
						<c:forEach var="member" items="${list_penalty}">
						    <tr>
						        ...
						        <td class="text-center ellipsis-content" data-toggle="tooltip" data-placement="top" title="전체 내용을 보려면 클릭하세요."">${member.r_content}</td>
						        <td class="text-center">${member.r_date}</td>
						        <td class="text-center">${member.penalty}</td>
						        <td class="text-center">${member.pro_date}</td>
						        <td class="text-center">${member.process}</td>
						    </tr>
						</c:forEach>
							<!-- <tr>
								...
								<td class="text-center">2024-02-26</td>
				             	<td class="text-center">욕설</td>
								<td class="text-center ellipsis-content" data-toggle="tooltip" data-placement="top" title="전체 내용을 보려면 클릭하세요.">나는 순수하게 질문을 했을 뿐인데 갑자기 부모님 안부를 물어보면서 욕하는게 말이 안된다고 생각합니다;;;;</td>
								<td class="text-center">2024-02-27</td>
								<td class="text-center">30일 작성 금지</td>
							</tr>	 -->								
						</tbody>
					</table>
				</div>
