...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		...
		function selChange() {
			...
			location.href="'<%=request.getContextPath() %>'ProjectList2.action?nowPage=${paging.nowPage}&cntPerPage="+sel;
		}
			...
			<div class="col-md-2" style="padding-left: 50px;">
				<aside class="l_widget forum_list">
                               ...
                               <ul class="navbar-nav ">
                                   ...
                                   <li class="activenav-item" id="side2">
					...
					<div class="forum_topic_list_inner">
	                            ...
	                            <div class="row pagination_inner">
	                                <div class="col-lg-2">
	                                    ...
	                                    <h6 class="total2" style="">Total: <span> ${ingcount } </span></h6>
	                          ...
	                          <!-- 전체 -->       
	                           <div id="list1" style="display: block; text-align: center;">		
									<c:if test="${paging.startPage != 1 }">
										<a href="<%=cp %>/ProjectList2.action?nowPage=${paging1.startPage - 1 }&cntPerPage=${paging.cntPerPage}">&lt;</a>
									</c:if>
									<c:forEach begin="${paging.startPage }" end="${paging.endPage }" var="p">
										<c:choose>
											...
											<c:when test="${p != paging1.nowPage }">
												<a href="<%=cp %>/ProjectList2.action?nowPage=${p }&cntPerPage=${paging.cntPerPage}">${p }</a>
											</c:when>
										</c:choose>
									</c:forEach>
									<c:if test="${paging.endPage != paging.lastPage}">
										<a href="<%=cp %>/ProjectList2.action?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}">&gt;</a>
									</c:if>
								</div>
	                            </div>
	                        </div>
